...
/*
curl 'https://192.168.1.24:8443/api/s/default/rest/firewallrule/601a4c93380ef804e5699a61' \
  -X 'DELETE' \
  -H 'Connection: keep-alive' \
  -H 'sec-ch-ua: "Chromium";v="88", "Google Chrome";v="88", ";Not A Brand";v="99"' \
  -H 'X-Csrf-Token: Z86yCmn38GVKjNmNozMpxllYo5hVKRVG' \
  ...
  -H 'Accept: *\/*' \
-H 'Origin: https://192.168.1.24:8443' \
-H 'Sec-Fetch-Site: same-origin' \
-H 'Sec-Fetch-Mode: cors' \
-H 'Sec-Fetch-Dest: empty' \
-H 'Referer: https://192.168.1.24:8443/manage/site/default/settings/firewall/rules/ipv4/list/WAN_IN' \
-H 'Accept-Language: en-US,en;q=0.9,ca;q=0.8' \
-H 'Cookie: unifises=DBkJKYZ4WDcoS0r16zbWAd4oNRZbaNYz; csrf_token=Z86yCmn38GVKjNmNozMpxllYo5hVKRVG' \
--compressed \
--insecure
*/
